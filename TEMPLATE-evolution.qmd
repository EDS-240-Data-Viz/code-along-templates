...
::: {.callout-note}
This template follows the [visualizing evolution](https://eds-240-data-viz.github.io/course-materials/lecture-slides/SLIDES-evolution.html#/title-slide){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
- line graphs encode data **by position** and **not length**
...
::: {.callout-note}
We’ve added tick marks for every value on the y-axis on the plot below to help visualize differences in aspect ratio – you would not typically present a plot in this way
:::
...
- we can **fix** the aspect ratio of our plot (i.e. height of one y-unit is equal to the width of one x-unit)
...
- we can adjust the aspect ratio by updating the value supplied to the ratio argument:
